...
1. Add the new variant into the state_types template in [`inst/cpp_generation/state_types.hpp.in`](https://github.com/mrc-ide/frogger/blob/main/inst/cpp_generation/state_types.hpp.in)
1. Add any new input or output data in [`inst/include/model_input.csv`](https://github.com/mrc-ide/frogger/blob/main/inst/cpp_generation/model_input.csv) or [`inst/include/model_output.csv`](https://github.com/mrc-ide/frogger/blob/main/inst/cpp_generation/model_output.csv) and regenerate.
1. Add parameters for this variant in [`inst/include/parameters.hpp`](https://github.com/mrc-ide/frogger/blob/main/inst/include/parameters.hpp)
...
1. Add a new top level function for this part of the model
1. Add a new conditional into the runner `frogger.cpp`
1. Reflect that in the R calling function
