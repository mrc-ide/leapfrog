...
| hTM      | hcTT     | Number of transmission types for the child population     |
...
| NA                 | run_child_model        | Whether the child model should be run             |
...
| hivqx_ha                  |                                 |                                                                           |
| hivdeaths_a               |                                 |                                                                           |
| age15_hivpop              | age15_hiv_pop                   | 15 year olds aging out of the child population                       |
