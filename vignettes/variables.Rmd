...
|          | hPS_agg  | Number of maternal infection categories (6): Never on ART,     |
|                        seroconversion during pregnancy,                              |
|                        seroconversion during breastfeeding,                          |
|                        on ART (LTFU by delivery),                                    | 
|                        on ART (LTFU during breastfeeding), on ART (retained)         |
...
|                  | hc_infections_coarse       | Number of paediatric infections stratified by coarse maternal treatment category, timing of transmission, age, sex, and year
