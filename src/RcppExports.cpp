...
// run_wlhiv_births_r
Rcpp::List run_wlhiv_births_r(const Rcpp::List data, const Rcpp::Nullable<Rcpp::NumericVector> sim_years, const SEXP hts_per_year, const Rcpp::NumericVector output_steps, const Rcpp::List data_from_adult_model);
RcppExport SEXP _frogger_run_wlhiv_births_r(SEXP dataSEXP, SEXP sim_yearsSEXP, SEXP hts_per_yearSEXP, SEXP output_stepsSEXP, SEXP data_from_adult_modelSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::List >::type data(dataSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::NumericVector> >::type sim_years(sim_yearsSEXP);
    Rcpp::traits::input_parameter< const SEXP >::type hts_per_year(hts_per_yearSEXP);
    Rcpp::traits::input_parameter< const Rcpp::NumericVector >::type output_steps(output_stepsSEXP);
    Rcpp::traits::input_parameter< const Rcpp::List >::type data_from_adult_model(data_from_adult_modelSEXP);
    rcpp_result_gen = Rcpp::wrap(run_wlhiv_births_r(data, sim_years, hts_per_year, output_steps, data_from_adult_model));
    return rcpp_result_gen;
END_RCPP
}
// serialize_vector
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_frogger_run_wlhiv_births_r", (DL_FUNC) &_frogger_run_wlhiv_births_r, 5},
