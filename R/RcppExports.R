...
run_base_model <- function(data, proj_years, hiv_steps, save_steps, model_variant) {
    .Call(`_frogger_run_base_model`, data, proj_years, hiv_steps, save_steps, model_variant)
}
