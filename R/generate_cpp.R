...
generate_output_interface <- function(dest) {
  ...
  default_data <- generate_data_section(default_section)
  ...
  optional_data <- Map(generate_optional_section,
...
generate_unpack_state_space <- function(outputs) {
  ...
  state_space_group <- unique(vcapply(strsplit(ss, "\\."), "[[", 1))
  vcapply(state_space_group, function(group) {
