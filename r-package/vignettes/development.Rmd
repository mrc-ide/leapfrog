...
This time output is managed by the state saver see [`r-package/int/include/state_saver.hpp`](https://github.com/mrc-ide/frogger/blob/main/r-package/int/include/state_saver.hpp)
...
Input data is generated from csv file in [`r-package/int/include/model_input.hpp`](https://github.com/mrc-ide/frogger/blob/main/r-package/int/include/model_input.hpp), the columns in this file are
...
After making changes to the [`model_input.csv`](https://github.com/mrc-ide/frogger/blob/main/inst/cpp_generation/model_input.csv), run the generate script [`scripts/generate`](https://github.com/mrc-ide/frogger/blob/main/scripts/generate). This update file [`r-package/int/include/model_input.hpp`](https://github.com/mrc-ide/frogger/blob/main/r-package/int/include/model_input.hpp). Note that this file should never be changed manually as the generate script will completely rewrite it.
...
The intermediate data is not handled by code generation as it only requires changes in one place. You can make modifications by adding new data into the struct in [`r-package/int/include/types.hpp`](https://github.com/mrc-ide/frogger/blob/main/r-package/int/include/types.hpp), making sure to set its default value in the `reset` function on the struct.
...
1. Add any new input or output data in [`r-package/int/include/model_input.csv`](https://github.com/mrc-ide/frogger/blob/main/inst/cpp_generation/model_input.csv) or [`r-package/int/include/model_output.csv`](https://github.com/mrc-ide/frogger/blob/main/inst/cpp_generation/model_output.csv)
...
1. Add your new variant in [`r-package/int/include/model_variants.hpp`](https://github.com/mrc-ide/frogger/blob/main/r-package/int/include/model_variants.hpp)
1. Add a struct for the new state space in [`r-package/int/include/state_space.hpp`](https://github.com/mrc-ide/frogger/blob/main/r-package/int/include/state_space.hpp)
1. If your model has new input data, add parameters for this variant in [`r-package/int/include/parameters.hpp`](https://github.com/mrc-ide/frogger/blob/main/r-package/int/include/parameters.hpp). Parameter types will be generated, you need to add those types to the appropriate template specialisation
1. If your model has new output data, add a new specialisation in [`r-package/int/include/state_saver.hpp`](https://github.com/mrc-ide/frogger/blob/main/r-package/int/include/state_saver.hpp)
