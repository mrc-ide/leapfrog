...
#' @export
prepare_hc_leapfrog_projp <- function(pjnz, params, asfr) {
  ...
  #v$asfr_coarse <- as.array(unname(asfr[fert_ages.idx,]))
  v$asfr_coarse <- as.array(rowsum(asfr, group = coarse_age_groups))
