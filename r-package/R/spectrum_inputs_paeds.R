...
input_pmtct_retained <- function(pjnz){
  ...
  out[c('Option A', 'Option B','Option B+: before pregnancy', 'Option B+: >4 weeks','Option B+: <4 weeks'),'breastfeeding <12 months',] <- matrix(unlist(dropout['pmtct_postnatal_monthlydropout_art0to12months',]), nrow = 5, ncol = dim(dropout)[2], byrow = TRUE)
  out[c('Option A', 'Option B','Option B+: before pregnancy', 'Option B+: >4 weeks','Option B+: <4 weeks'),'breastfeeding 12+ months',] <- matrix(unlist(dropout['pmtct_postnatal_monthlydropout_art12plusmonths',]), nrow = 5, ncol = dim(dropout)[2], byrow = TRUE)
