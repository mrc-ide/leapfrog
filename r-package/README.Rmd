...
The simulation model is implemented in a header-only C++ library located in [`r-package/int/include/frogger.hpp`](r-package/int/include/frogger.hpp). This location allows the C++ code to be imported in other R packages via specifying `LinkingTo: leapfrog` in the `DESCRIPTION` file.
