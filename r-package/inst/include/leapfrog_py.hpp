 ...
 * @param proj_step The time step to run, used in index parameters
...
void project_single_year(int proj_step,
  ...
  internal::project_year(proj_step, pars, state_curr, state_next, intermediate);
}
