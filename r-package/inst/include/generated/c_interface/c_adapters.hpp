...
struct HaAdapter<Language::C, real_type, ModelVariant> {
  ...
  static Config::State get_initial_state(
    ...
    fill_initial_state<real_type, typename Config::State::shape_hiv_net_migration>(state.ha->hiv_net_migration, state.ha->hiv_net_migration_length, "hiv_net_migration", initial_state.hiv_net_migration);
    return initial_state;
  };
  ...
  static int build_output(
    ...
    write_data<real_type, typename Config::OutputState::shape_hiv_net_migration>(state.hiv_net_migration, out.ha->hiv_net_migration, out.ha->hiv_net_migration_length, "hiv_net_migration");
    return index + output_count;
  };
  ...
  static int build_output_single_year(
    ...
    write_data<real_type, typename Config::State::shape_hiv_net_migration>(state.hiv_net_migration, out.ha->hiv_net_migration, out.ha->hiv_net_migration_length, "hiv_net_migration");
    return index + output_count;
  };
};
