...
struct HaAdapter<Language::C, real_type, ModelVariant> {
  ...
  static Config::Pars get_pars(
    ...
    return {
      ...
      .fert_mult_by_age = read_data<real_type, 2>(params.ha->fert_mult_by_age, params.ha->fert_mult_by_age_length, "fert_mult_by_age", { nda::dim<>(0, SS::p_fertility_age_groups, 1), nda::dim<>(0, opts.proj_steps, (SS::p_fertility_age_groups)) }),
      ...
      .fert_mult_on_art = read_data<real_type, 1>(params.ha->fert_mult_on_art, params.ha->fert_mult_on_art_length, "fert_mult_on_art", { nda::dim<>(0, SS::p_fertility_age_groups, 1) }),
