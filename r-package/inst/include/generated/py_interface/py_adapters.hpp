...
struct HcAdapter<Language::Py, real_type, ModelVariant> {
  ...
  static Config::Pars get_pars(
    ...
    return {
      ...
      .bigpop = parse_data<real_type, 3>(data, "bigpop", { nda::dim<>(0, SS::pAG, 1), nda::dim<>(0, SS::NS, (SS::pAG)), nda::dim<>(0, opts.proj_steps, (SS::pAG) * (SS::NS)) }),
      ...
      .local_adj_factor = nb::cast<real_type>(data["laf"])
    };
  };
