...
struct HaOwnedPars {
  ...
  static Pars parse_pars(
    ...
    return {
      ...
      .fert_mult_by_age = read_data<real_type, typename Pars::shape_fert_mult_by_age>(params_file, "fert_rat", { nda::dim<>(0, SS::p_fertility_age_groups, 1), nda::dim<>(0, opts.proj_steps, (SS::p_fertility_age_groups)) }),
      .fert_mult_off_art = read_data<real_type, typename Pars::shape_fert_mult_off_art>(params_file, "cd4fert_rat", { nda::dim<>(0, SS::hDS, 1) }),
      .fert_mult_on_art = read_data<real_type, typename Pars::shape_fert_mult_on_art>(params_file, "frr_art6mos", { nda::dim<>(0, SS::p_fertility_age_groups, 1) }),
...
struct HcOwnedPars {
  ...
  static Pars parse_pars(
    ...
    return {
      ...
      .local_adj_factor = read_data_scalar<real_type>(params_file, "frr_scalar"),
      .hc_age_specific_fertility_rate = read_data<real_type, typename Pars::shape_hc_age_specific_fertility_rate>(params_file, "hc_asfr", { nda::dim<>(0, SS::p_fertility_age_groups, 1), nda::dim<>(0, opts.proj_steps, (SS::p_fertility_age_groups)) })
    };
  };
};
