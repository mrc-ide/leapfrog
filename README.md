...
| hiv_steps_per_year | ?                   |                                   |
| t_ART_start        | ?                   | Time step to start modelling ART  |
...
| incidinput         | ?                       |                                                                                              |
| incrr_sex          | ?                       | Relative risk of incidence by sex                                                            |
| incrr_age          | ?                       | Relative risk of incidence by age                                                            |
...
|---------------------------|----------------------------|---------------------------------------------------------------------------|
| ART0MOS                   | ?                          |                                                                           |
| pIDX_INCIDPOP             | ?                          | Index of youngest age that is reflected in the adult incidence input      |
| pAG_INCIDPOP              | ?                          |                                                                           |
| hAG_15PLUS                | ?                          |                                                                           |
| hIDX_15PLUS               | ?                          |                                                                           |
| h_art_stage_dur           | ?                          |                                                                           |
...
| hivn_ag                   |                            | HIV negative population for a given age and sex                           |
| Xhivn                     |                            |                                                                           |
| Xhivn_incagerr            |                            |                                                                           |
| incrate_i                 |                            | Incidence rate input                                                      |
| incrate_g                 |                            | Incidence rate by sex                                                     |
| hivdeaths_ha              |                            |                                                                           |
| grad                      |                            | Movement between cd4 categories at a given time step                      |
| artpop_hahm               |                            |                                                                           |
| cd4mx_scale               |                            |                                                                           |
| infections_a              |                            |                                                                           |
| infections_ha             |                            |                                                                           |
