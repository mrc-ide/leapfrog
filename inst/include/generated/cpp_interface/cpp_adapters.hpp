...
struct HcAdapter<Language::Cpp, real_type, ModelVariant> {
  ...
  static Config::Pars get_pars(
    ...
    return {
      ...
      .hc_art_init_dist_htn = read_data<real_type>(input_dir, "hc_art_init_dist_htn", opts.p_idx_hiv_first_adult, SS::hTN),
  ...
  static int build_output(
    ...
    serialize::serialize_tensor<real_type, 4>(state.hc_tr_coarse, output_dir / "hc_tr_coarse");
    ...
    serialize::serialize_tensor<real_type, 7>(state.hc2_hiv_pop_strat, output_dir / "hc2_hiv_pop_strat");
    serialize::serialize_tensor<real_type, 5>(state.hc1_art_pop, output_dir / "hc1_art_pop");
    serialize::serialize_tensor<real_type, 8>(state.hc1_art_pop_strat, output_dir / "hc1_art_pop_strat");
    serialize::serialize_tensor<real_type, 5>(state.hc2_art_pop, output_dir / "hc2_art_pop");
    serialize::serialize_tensor<real_type, 8>(state.hc2_art_pop_strat, output_dir / "hc2_art_pop_strat");
    serialize::serialize_tensor<real_type, 5>(state.hc1_noart_aids_deaths, output_dir / "hc1_noart_aids_deaths");
    serialize::serialize_tensor<real_type, 7>(state.hc1_noart_aids_deaths_strat, output_dir / "hc1_noart_aids_deaths_strat");
    serialize::serialize_tensor<real_type, 5>(state.hc2_noart_aids_deaths, output_dir / "hc2_noart_aids_deaths");
    serialize::serialize_tensor<real_type, 7>(state.hc2_noart_aids_deaths_strat, output_dir / "hc2_noart_aids_deaths_strat");
    serialize::serialize_tensor<real_type, 5>(state.hc1_art_aids_deaths, output_dir / "hc1_art_aids_deaths");
    serialize::serialize_tensor<real_type, 8>(state.hc1_art_aids_deaths_strat, output_dir / "hc1_art_aids_deaths_strat");
    serialize::serialize_tensor<real_type, 5>(state.hc2_art_aids_deaths, output_dir / "hc2_art_aids_deaths");
    serialize::serialize_tensor<real_type, 8>(state.hc2_art_aids_deaths_strat, output_dir / "hc2_art_aids_deaths_strat");
    ...
    serialize::serialize_tensor<real_type, 7>(state.hc_art_need_init_strat, output_dir / "hc_art_need_init_strat");
