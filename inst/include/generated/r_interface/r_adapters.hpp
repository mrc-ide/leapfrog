...
struct HcAdapter<Language::R, real_type, ModelVariant> {
  ...
  static int build_output(
    ...
    names[index + 2] = "hc1_hiv_pop";
    ret[index + 2] = r_hc1_hiv_pop;
    ...
    names[index + 3] = "hc1_hiv_pop_strat";
    ret[index + 3] = r_hc1_hiv_pop_strat;
    ...
    names[index + 4] = "hc2_hiv_pop";
    ret[index + 4] = r_hc2_hiv_pop;
    ...
    names[index + 5] = "hc2_hiv_pop_strat";
    ret[index + 5] = r_hc2_hiv_pop_strat;
    ...
    names[index + 6] = "hc1_art_pop";
    ret[index + 6] = r_hc1_art_pop;
    ...
    names[index + 7] = "hc1_art_pop_strat";
    ret[index + 7] = r_hc1_art_pop_strat;
    ...
    names[index + 8] = "hc2_art_pop";
    ret[index + 8] = r_hc2_art_pop;
    ...
    names[index + 9] = "hc2_art_pop_strat";
    ret[index + 9] = r_hc2_art_pop_strat;
    ...
    names[index + 10] = "hc1_noart_aids_deaths";
    ret[index + 10] = r_hc1_noart_aids_deaths;
    ...
    names[index + 11] = "hc1_noart_aids_deaths_strat";
    ret[index + 11] = r_hc1_noart_aids_deaths_strat;
    ...
    names[index + 12] = "hc2_noart_aids_deaths";
    ret[index + 12] = r_hc2_noart_aids_deaths;
    ...
    names[index + 13] = "hc2_noart_aids_deaths_strat";
    ret[index + 13] = r_hc2_noart_aids_deaths_strat;
    ...
    names[index + 14] = "hc1_art_aids_deaths";
    ret[index + 14] = r_hc1_art_aids_deaths;
    ...
    names[index + 15] = "hc1_art_aids_deaths_strat";
    ret[index + 15] = r_hc1_art_aids_deaths_strat;
    ...
    names[index + 16] = "hc2_art_aids_deaths";
    ret[index + 16] = r_hc2_art_aids_deaths;
    ...
    names[index + 17] = "hc2_art_aids_deaths_strat";
    ret[index + 17] = r_hc2_art_aids_deaths_strat;
    ...
    names[index + 18] = "hc_art_init";
    ret[index + 18] = r_hc_art_init;
    ...
    names[index + 19] = "hc_art_need_init";
    ret[index + 19] = r_hc_art_need_init;
    ...
    names[index + 20] = "hc_art_need_init_strat";
    ret[index + 20] = r_hc_art_need_init_strat;
    ...
    names[index + 21] = "hiv_births";
    ret[index + 21] = r_hiv_births;
    ...
    names[index + 22] = "ctx_need";
    ret[index + 22] = r_ctx_need;
    ...
    names[index + 23] = "infection_by_type";
    ret[index + 23] = r_infection_by_type;
    return index + output_count;
  };
  ...
  static int build_output_single_year(
    ...
    ret[index + 20] = r_hc_art_need_init_strat;
    names[index + 21] = "hiv_births";
    ret[index + 21] = state.hiv_births;
    names[index + 22] = "ctx_need";
    ret[index + 22] = state.ctx_need;
