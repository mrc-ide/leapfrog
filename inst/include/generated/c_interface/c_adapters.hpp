...
struct DpAdapter<Language::C, real_type, ModelVariant> {
  ...
  static Config::Pars get_pars(
    ...
    return {
      ...
      .survival_probability = read_data<real_type>(params.dp->survival_probability, params.dp->survival_probability_length, "survival_probability", SS::pAG + 1, SS::NS, opts.proj_steps),
      .net_migration = read_data<real_type>(params.dp->net_migration, params.dp->net_migration_length, "net_migration", SS::pAG, SS::NS, opts.proj_steps),
      .age_specific_fertility_rate = read_data<real_type>(params.dp->age_specific_fertility_rate, params.dp->age_specific_fertility_rate_length, "age_specific_fertility_rate", SS::p_fertility_age_groups, opts.proj_steps),
      .births_sex_prop = read_data<real_type>(params.dp->births_sex_prop, params.dp->births_sex_prop_length, "births_sex_prop", SS::NS, opts.proj_steps)
    };
  };
...
struct HaAdapter<Language::C, real_type, ModelVariant> {
  ...
  static Config::Pars get_pars(
    ...
    return {
      .total_rate = read_data<real_type>(params.ha->total_rate, params.ha->total_rate_length, "total_rate", opts.proj_steps),
      .relative_risk_age = read_data<real_type>(params.ha->relative_risk_age, params.ha->relative_risk_age_length, "relative_risk_age", SS::pAG - SS::p_idx_hiv_first_adult, SS::NS, opts.proj_steps),
      .relative_risk_sex = read_data<real_type>(params.ha->relative_risk_sex, params.ha->relative_risk_sex_length, "relative_risk_sex", opts.proj_steps),
      ...
      .idx_hm_elig = read_data<int>(params.ha->idx_hm_elig, params.ha->idx_hm_elig_length, "idx_hm_elig", opts.proj_steps),
      .mortality = read_data<real_type>(params.ha->mortality, params.ha->mortality_length, "mortality", SS::hTS, SS::hDS, SS::hAG, SS::NS),
      .mortality_time_rate_ratio = read_data<real_type>(params.ha->mortality_time_rate_ratio, params.ha->mortality_time_rate_ratio_length, "mortality_time_rate_ratio", SS::hTS, opts.proj_steps),
      .dropout_recover_cd4 = params.ha->dropout_recover_cd4,
      .dropout_rate = read_data<real_type>(params.ha->dropout_rate, params.ha->dropout_rate_length, "dropout_rate", opts.proj_steps),
      .adults_on_art = read_data<real_type>(params.ha->adults_on_art, params.ha->adults_on_art_length, "adults_on_art", SS::NS, opts.proj_steps),
      .adults_on_art_is_percent = read_data<int>(params.ha->adults_on_art_is_percent, params.ha->adults_on_art_is_percent_length, "adults_on_art_is_percent", SS::NS, opts.proj_steps),
...
struct HcAdapter<Language::C, real_type, ModelVariant> {
  ...
  static Config::Pars get_pars(
    ...
    return {
      .hc_nosocomial = read_data<real_type>(params.hc->hc_nosocomial, params.hc->hc_nosocomial_length, "hc_nosocomial", opts.proj_steps),
      ...
      .ctx_val = read_data<real_type>(params.hc->ctx_val, params.hc->ctx_val_length, "ctx_val", opts.proj_steps),
      .hc_art_elig_age = read_data<int>(params.hc->hc_art_elig_age, params.hc->hc_art_elig_age_length, "hc_art_elig_age", opts.proj_steps),
      .hc_art_elig_cd4 = read_data<int>(params.hc->hc_art_elig_cd4, params.hc->hc_art_elig_cd4_length, "hc_art_elig_cd4", SS::p_idx_hiv_first_adult, opts.proj_steps),
      .hc_art_mort_rr = read_data<real_type>(params.hc->hc_art_mort_rr, params.hc->hc_art_mort_rr_length, "hc_art_mort_rr", SS::hTS, SS::p_idx_hiv_first_adult, opts.proj_steps),
      ...
      .hc_art_isperc = read_data<int>(params.hc->hc_art_isperc, params.hc->hc_art_isperc_length, "hc_art_isperc", opts.proj_steps),
      .hc_art_val = read_data<real_type>(params.hc->hc_art_val, params.hc->hc_art_val_length, "hc_art_val", SS::hcAG_coarse, opts.proj_steps),
      .hc_art_init_dist = read_data<real_type>(params.hc->hc_art_init_dist, params.hc->hc_art_init_dist_length, "hc_art_init_dist", SS::p_idx_hiv_first_adult, opts.proj_steps),
      .fert_mult_by_age = read_data<real_type>(params.hc->fert_mult_by_age, params.hc->fert_mult_by_age_length, "fert_mult_by_age", SS::hAG_fert, opts.proj_steps),
      ...
      .total_fertility_rate = read_data<real_type>(params.hc->total_fertility_rate, params.hc->total_fertility_rate_length, "total_fertility_rate", opts.proj_steps),
      .PMTCT = read_data<real_type>(params.hc->PMTCT, params.hc->PMTCT_length, "PMTCT", SS::hPS, opts.proj_steps),
      ...
      .PMTCT_dropout = read_data<real_type>(params.hc->PMTCT_dropout, params.hc->PMTCT_dropout_length, "PMTCT_dropout", SS::hPS_dropout, opts.proj_steps),
      .PMTCT_input_is_percent = read_data<int>(params.hc->PMTCT_input_is_percent, params.hc->PMTCT_input_is_percent_length, "PMTCT_input_is_percent", opts.proj_steps),
      .breastfeeding_duration_art = read_data<real_type>(params.hc->breastfeeding_duration_art, params.hc->breastfeeding_duration_art_length, "breastfeeding_duration_art", SS::hBF, opts.proj_steps),
      .breastfeeding_duration_no_art = read_data<real_type>(params.hc->breastfeeding_duration_no_art, params.hc->breastfeeding_duration_no_art_length, "breastfeeding_duration_no_art", SS::hBF, opts.proj_steps),
      .mat_hiv_births = read_data<real_type>(params.hc->mat_hiv_births, params.hc->mat_hiv_births_length, "mat_hiv_births", opts.proj_steps),
      .mat_prev_input = read_data<int>(params.hc->mat_prev_input, params.hc->mat_prev_input_length, "mat_prev_input", opts.proj_steps),
      .prop_lt200 = read_data<real_type>(params.hc->prop_lt200, params.hc->prop_lt200_length, "prop_lt200", opts.proj_steps),
      .prop_gte350 = read_data<real_type>(params.hc->prop_gte350, params.hc->prop_gte350_length, "prop_gte350", opts.proj_steps),
      .ctx_val_is_percent = read_data<int>(params.hc->ctx_val_is_percent, params.hc->ctx_val_is_percent_length, "ctx_val_is_percent", opts.proj_steps),
      .hc_art_is_age_spec = read_data<int>(params.hc->hc_art_is_age_spec, params.hc->hc_art_is_age_spec_length, "hc_art_is_age_spec", opts.proj_steps),
      .abortion = read_data<real_type>(params.hc->abortion, params.hc->abortion_length, "abortion", SS::hAB_ind, opts.proj_steps),
      .patients_reallocated = read_data<real_type>(params.hc->patients_reallocated, params.hc->patients_reallocated_length, "patients_reallocated", opts.proj_steps),
      .hc_art_ltfu = read_data<real_type>(params.hc->hc_art_ltfu, params.hc->hc_art_ltfu_length, "hc_art_ltfu", opts.proj_steps),
      .adult_female_infections = read_data<real_type>(params.hc->adult_female_infections, params.hc->adult_female_infections_length, "adult_female_infections", SS::p_fertility_age_groups, opts.proj_steps),
      .adult_female_hivnpop = read_data<real_type>(params.hc->adult_female_hivnpop, params.hc->adult_female_hivnpop_length, "adult_female_hivnpop", SS::p_fertility_age_groups, opts.proj_steps),
      .total_births = read_data<real_type>(params.hc->total_births, params.hc->total_births_length, "total_births", opts.proj_steps),
