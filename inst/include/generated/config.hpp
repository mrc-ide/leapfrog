...
struct HcConfig {
  ...
  struct Pars {
    ...
    using shape_hc_cd4_transition = nda::shape<
      nda::dim<0, SS::hc2DS, 1>,
      nda::dim<0, SS::hc1DS, (SS::hc2DS)>
    >;
    nda::array_ref<real_type, shape_hc_cd4_transition> hc_cd4_transition;
    ...
    using shape_hc_art_elig_cd4 = nda::shape<
      ...
      nda::dim<0, nda::dynamic, nda::dynamic>
    >;
    nda::array_ref<real_type, shape_hc_art_elig_cd4> hc_art_elig_cd4;
    ...
    using shape_adult_cd4_dist = nda::shape<
      nda::dim<0, SS::hDS, 1>,
      nda::dim<0, SS::hc2DS, (SS::hDS)>
    >;
    nda::array_ref<real_type, shape_adult_cd4_dist> adult_cd4_dist;
    ...
    using shape_incrate = nda::shape<
      nda::dim<0, nda::dynamic, 1>
    >;
    nda::array_ref<real_type, shape_incrate> incrate;
    ...
    using shape_hc_age_coarse = nda::shape<
      nda::dim<0, SS::hcAG_end, 1>
    >;
    nda::array_ref<real_type, shape_hc_age_coarse> hc_age_coarse;
    ...
    using shape_hc_age_coarse_cd4 = nda::shape<
      nda::dim<0, nda::dynamic, 1>
    >;
    nda::array_ref<int, shape_hc_age_coarse_cd4> hc_age_coarse_cd4;
