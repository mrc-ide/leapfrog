...
struct DpConfig {
  ...
  static Pars get_pars(
    ...
    return {
      .base_pop = parse_data<real_type>(data, "base_pop", SS::pAG, SS::NS),
      .survival_probability = parse_data<real_type>(data, "survival_probability", SS::pAG + 1, SS::NS, proj_years),
      .net_migration = parse_data<real_type>(data, "net_migration", SS::pAG, SS::NS, proj_years),
      .age_specific_fertility_rate = parse_data<real_type>(data, "age_specific_fertility_rate", opts.p_fertility_age_groups, proj_years),
...
struct HaConfig {
  ...
  static Pars get_pars(
    ...
    return {
      .total_rate = parse_data<real_type>(data, "total_rate", proj_years),
      .relative_risk_age = parse_data<real_type>(data, "relative_risk_age", SS::pAG - opts.p_idx_hiv_first_adult, SS::NS, proj_years),
      .relative_risk_sex = parse_data<real_type>(data, "relative_risk_sex", proj_years),
      .cd4_mortality = parse_data<real_type>(data, "cd4_mortality", SS::hDS, SS::hAG, SS::NS),
      .cd4_progression = parse_data<real_type>(data, "cd4_progression", SS::hDS - 1, SS::hAG, SS::NS),
      .cd4_initial_distribution = parse_data<real_type>(data, "cd4_initial_distribution", SS::hDS, SS::hAG, SS::NS),
      .scale_cd4_mortality = parse_data<int>(data, "scale_cd4_mortality"),
      .idx_hm_elig = parse_data<int>(data, "idx_hm_elig", proj_years),
      .mortality = parse_data<real_type>(data, "mortality", SS::hTS, SS::hDS, SS::hAG, SS::NS),
      .mortality_time_rate_ratio = parse_data<real_type>(data, "mortality_time_rate_ratio", SS::hTS, proj_years),
      .dropout_recover_cd4 = parse_data<int>(data, "dropout_recover_cd4"),
      .dropout_rate = parse_data<real_type>(data, "dropout_rate", proj_years),
      .adults_on_art = parse_data<real_type>(data, "adults_on_art", SS::NS, proj_years),
      .adults_on_art_is_percent = parse_data<int>(data, "adults_on_art_is_percent", SS::NS, proj_years),
      .h_art_stage_dur = parse_data<real_type>(data, "h_art_stage_dur", SS::hTS - 1),
      .initiation_mortality_weight = parse_data<real_type>(data, "initiation_mortality_weight")
    };
  };
...
struct HcConfig {
  ...
  static Pars get_pars(
    ...
    return {
      .hc_nosocomial = parse_data<real_type>(data, "hc_nosocomial", proj_years),
      .hc1_cd4_dist = parse_data<real_type>(data, "hc1_cd4_dist", SS::hc2DS),
      .hc_cd4_transition = parse_data<real_type>(data, "hc_cd4_transition", SS::hc2DS, SS::hc1DS),
      .hc1_cd4_mort = parse_data<real_type>(data, "hc1_cd4_mort", SS::hc1DS, SS::hcTT, SS::hc1AG),
      .hc2_cd4_mort = parse_data<real_type>(data, "hc2_cd4_mort", SS::hc2DS, SS::hcTT, SS::hc2AG),
      .hc1_cd4_prog = parse_data<real_type>(data, "hc1_cd4_prog", SS::hc1DS, SS::hc1AG_c, SS::NS),
      .hc2_cd4_prog = parse_data<real_type>(data, "hc2_cd4_prog", SS::hc2DS, SS::hc2AG_c, SS::NS),
      .ctx_val = parse_data<real_type>(data, "ctx_val", proj_years),
      .hc_art_elig_age = parse_data<int>(data, "hc_art_elig_age", proj_years),
      .hc_art_elig_cd4 = parse_data<real_type>(data, "hc_art_elig_cd4", opts.p_idx_hiv_first_adult, proj_years),
      .hc_art_mort_rr = parse_data<real_type>(data, "hc_art_mort_rr", SS::hTS, opts.p_idx_hiv_first_adult, proj_years),
      .hc1_art_mort = parse_data<real_type>(data, "hc1_art_mort", SS::hc1DS, SS::hTS, SS::hc1AG),
      .hc2_art_mort = parse_data<real_type>(data, "hc2_art_mort", SS::hc2DS, SS::hTS, SS::hc2AG),
      .hc_art_isperc = parse_data<int>(data, "hc_art_isperc", proj_years),
      .hc_art_val = parse_data<real_type>(data, "hc_art_val", SS::hcAG_coarse, proj_years),
      .hc_art_init_dist = parse_data<real_type>(data, "hc_art_init_dist", opts.p_idx_hiv_first_adult, proj_years),
      ...
      .fert_mult_off_art = parse_data<real_type>(data, "fert_mult_off_art", SS::hDS),
      .fert_mult_on_art = parse_data<real_type>(data, "fert_mult_on_art", opts.p_fertility_age_groups),
      .total_fertility_rate = parse_data<real_type>(data, "total_fertility_rate", proj_years),
      .PMTCT = parse_data<real_type>(data, "PMTCT", SS::hPS, proj_years),
      .vertical_transmission_rate = parse_data<real_type>(data, "vertical_transmission_rate", SS::hDS + 1, SS::hVT),
      .PMTCT_transmission_rate = parse_data<real_type>(data, "PMTCT_transmission_rate", SS::hDS, SS::hPS, SS::hVT),
      .PMTCT_dropout = parse_data<real_type>(data, "PMTCT_dropout", SS::hPS_dropout, proj_years),
      .PMTCT_input_is_percent = parse_data<int>(data, "PMTCT_input_is_percent", proj_years),
      .breastfeeding_duration_art = parse_data<real_type>(data, "breastfeeding_duration_art", SS::hBF, proj_years),
      .breastfeeding_duration_no_art = parse_data<real_type>(data, "breastfeeding_duration_no_art", SS::hBF, proj_years),
      ...
      .ctx_val_is_percent = parse_data<int>(data, "ctx_val_is_percent", proj_years),
      .hc_art_is_age_spec = parse_data<int>(data, "hc_art_is_age_spec", proj_years),
      ...
      .hc_art_ltfu = parse_data<real_type>(data, "hc_art_ltfu", proj_years),
