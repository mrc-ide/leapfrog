...
py::dict build_python_output(const OutputState<ModelVariant, real_type> &state,
  ...
  py::array_t<real_type, py::array::f_style> p_total_pop({base.pAG, base.NS, output_years}, state.dp.p_total_pop.data());
  py::array_t<real_type, py::array::f_style> births({output_years}, state.dp.births.data());
  py::array_t<real_type, py::array::f_style> p_total_pop_natural_deaths({base.pAG, base.NS, output_years}, state.dp.p_total_pop_natural_deaths.data());
  py::array_t<real_type, py::array::f_style> p_hiv_pop({base.pAG, base.NS, output_years}, state.hiv.p_hiv_pop.data());
  py::array_t<real_type, py::array::f_style> p_hiv_pop_natural_deaths({base.pAG, base.NS, output_years}, state.hiv.p_hiv_pop_natural_deaths.data());
  py::array_t<real_type, py::array::f_style> h_hiv_adult({base.hDS, base.hAG, base.NS, output_years}, state.hiv.h_hiv_adult.data());
  py::array_t<real_type, py::array::f_style> h_art_adult({base.hTS, base.hDS, base.hAG, base.NS, output_years}, state.hiv.h_art_adult.data());
  py::array_t<real_type, py::array::f_style> h_hiv_deaths_no_art({base.hDS, base.hAG, base.NS, output_years}, state.hiv.h_hiv_deaths_no_art.data());
  py::array_t<real_type, py::array::f_style> p_infections({base.pAG, base.NS, output_years}, state.hiv.p_infections.data());
  py::array_t<real_type, py::array::f_style> h_hiv_deaths_art({base.hTS, base.hDS, base.hAG, base.NS, output_years}, state.hiv.h_hiv_deaths_art.data());
  py::array_t<real_type, py::array::f_style> h_art_initiation({base.hDS, base.hAG, base.NS, output_years}, state.hiv.h_art_initiation.data());
  py::array_t<real_type, py::array::f_style> p_hiv_deaths({base.pAG, base.NS, output_years}, state.hiv.p_hiv_deaths.data());
