    ...
    OutputState(int pAG,
        ...
        : p_total_pop(StateSpace<S>().pAG, StateSpace<S>().NS, no_output_years),
          ...
          hc2_hiv_pop(StateSpace<S>().hc2DS, StateSpace<S>().hcTT, StateSpace<S>().hc2AG,
                     StateSpace<S>().NS, no_output_years),
          hc1_art_pop(StateSpace<S>().treatment_stages, StateSpace<S>().hc1DS, StateSpace<S>().hc1AG,
                                 StateSpace<S>().NS, no_output_years),
          hc2_art_pop(StateSpace<S>().treatment_stages, StateSpace<S>().hc2DS, StateSpace<S>().hc2AG,
                                             StateSpace<S>().NS, no_output_years),
          hc1_art_aids_deaths(StateSpace<S>().treatment_stages, StateSpace<S>().hc1DS, StateSpace<S>().hc1AG,
                                             StateSpace<S>().NS, no_output_years),
          hc2_art_aids_deaths(StateSpace<S>().treatment_stages, StateSpace<S>().hc2DS, StateSpace<S>().hc2AG,
                                   StateSpace<S>().NS, no_output_years),
