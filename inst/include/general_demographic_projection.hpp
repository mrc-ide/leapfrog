...
void run_ageing_and_mortality(int time_step,
  ...
  for (int g = 0; g < ss.NS; ++g) {
    ...
    for (int a = 1; a < ss.pAG; ++a) {
      state_next.base.p_total_pop_natural_deaths(a, g) = state_curr.base.p_total_pop(a - 1, g) *
                                                         (1.0 - demog.survival_probability(a, g, time_step));
      state_next.base.p_total_pop(a, g) =
          state_curr.base.p_total_pop(a - 1, g) -
          state_next.base.p_total_pop_natural_deaths(a, g);
    }

    // open age group
    real_type p_total_pop_natural_deaths_open_age =
        state_curr.base.p_total_pop(ss.pAG - 1, g) *
        (1.0 - demog.survival_probability(ss.pAG, g, time_step));
    state_next.base.p_total_pop_natural_deaths(ss.pAG - 1, g) +=
        p_total_pop_natural_deaths_open_age;
    state_next.base.p_total_pop(ss.pAG - 1, g) +=
        state_curr.base.p_total_pop(ss.pAG - 1, g) -
        p_total_pop_natural_deaths_open_age;
  }
}
