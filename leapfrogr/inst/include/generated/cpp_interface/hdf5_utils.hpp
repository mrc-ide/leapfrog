...
struct HcOwnedPars {
  ...
  static Pars parse_pars(
    ...
    return {
      ...
      .adult_female_hivnpop = read_data<real_type, typename Pars::shape_adult_female_hivnpop>(params_file, "adult_female_hivnpop", { nda::dim<>(0, SS::hAG_fertility, 1), nda::dim<>(0, opts.proj_steps, (SS::hAG_fertility)) }),
